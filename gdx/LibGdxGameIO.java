...
public class LibGdxGameIO implements GameIO {
    ...
    public LibGdxGameIO(Consumer<String> messageConsumer,
    ...
    public void println(String message) {
        ...
        postToMainThread(() -> messageConsumer.accept(message));
    }
    ...
    public void updateHero(Hero hero) {
        ...
        postToMainThread(() -> heroConsumer.accept(hero));
    }
    ...
    public void updateRoom(Room room) {
        ...
        postToMainThread(() -> roomConsumer.accept(room));
    }
    ...
    public void onGameFinished(boolean heroWon) {
        ...
        postToMainThread(() -> finishedConsumer.accept(heroWon));
    }
